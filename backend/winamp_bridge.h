...
extern __declspec(dllexport) void InitCallbacks(TrackUpdateCallback tCb, StatusCallback sCb);
extern __declspec(dllexport) void StartPresence(char* clientID, char* lastFmKey);
extern __declspec(dllexport) void StopPresence(void);
